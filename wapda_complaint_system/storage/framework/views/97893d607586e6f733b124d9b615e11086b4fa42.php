<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('CityList')); ?>" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('DivisionList')); ?>">
              <i class="menu-icon mdi mdi-backup-restore"></i>
              <span class="menu-title">Divisions</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('ComplaintList')); ?>">
              <i class="menu-icon mdi mdi-chart-line"></i>
              <span class="menu-title">Complaints</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('SubDivisionList')); ?>">
